...
from mistral_service import translate_texts
...
def main():
    try:
        ...
        # 4. 批量翻译
        logger.info(f"\n[步骤 4/4] 使用 Mistral API 批量翻译简介...")
        chinese_summaries = translate_texts(summaries_to_translate, mistral_api_key, batch_size)
